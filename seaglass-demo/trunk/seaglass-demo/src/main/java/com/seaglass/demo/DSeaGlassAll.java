...
public class DSeaGlassAll extends JFrame {
    ...
    private JMenuBar createMenuBar() {
        ...
        menuItem = new JMenuItem(new ImageIcon(DSeaGlassAll.class.getResource("/com/sun/swingset3/resources/images/lock.png")));
    ...
    private JToolBar createToolBar() {
        ...
        JButton buttonOne = new JButton(new ImageIcon(DSeaGlassAll.class.getResource("/com/sun/swingset3/resources/images/mailbox.png")));
        ...
        buttonTwo.setIcon(new ImageIcon(DSeaGlassAll.class.getResource("/com/sun/swingset3/resources/images/lock.png")));
