...
public abstract class AbstractCommonColorsPainter extends AbstractRegionPainter {
    ...
    private FourColors interiorEnabled                 = new FourColors(interiorTopEnabled, interiorUpperMidEnabled,
                                                           interiorLowerMidEnabled, interiorBottomEnabled);
    private FourColors interiorPressed                 = new FourColors(interiorTopPressed, interiorUpperMidPressed,
                                                           interiorLowerMidPressed, interiorBottomPressed);
    private FourColors interiorSelected                = new FourColors(interiorTopSelected, interiorUpperMidSelected,
                                                           interiorLowerMidSelected, interiorBottomSelected);
