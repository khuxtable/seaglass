 ...
 * ImageScalingHelper
 *
 * <p>Based on Nimbus's ImageScalingHelper by Jasper Potts. This was package
 * local.</p>
 *
...
public class ImageScalingHelper {
     ...
     * @param image     Image to render from, if <code>null</code> this method
     *                  will do nothing
     * @param sInsets   Insets specifying the portion of the image that will be
     *                  stretched or tiled, if <code>null</code> empty <code>
     *                  Insets</code> will be used.
     ...
     * @param mask      Specifies portion of image to render, if <code>
     *                  PAINT_ALL</code> is specified, any other regions
     ...
     * @param dx1   the x coordinate of the first corner of the destination
     *              rectangle.
     * @param dy1   the y coordinate of the first corner of the destination
     *              rectangle.
     * @param dx2   the x coordinate of the second corner of the destination
     *              rectangle.
     * @param dy2   the y coordinate of the second corner of the destination
     *              rectangle.
     * @param sx1   the x coordinate of the first corner of the source
     *              rectangle.
     * @param sy1   the y coordinate of the first corner of the source
     *              rectangle.
     * @param sx2   the x coordinate of the second corner of the source
     *              rectangle.
     * @param sy2   the y coordinate of the second corner of the source
     *              rectangle.
     */
