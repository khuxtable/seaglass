/*
 * TableHeaderRendererPainter.java %E%
 *
...
public final class TableHeaderRendererPainter extends AbstractRegionPainter {
    ...
    private Color color2 = decodeColor("seaglassTableHeaderBlueGrey", -0.01111114f, -0.08625447f, 0.062745094f, 0);
    private Color color3 = decodeColor("seaglassTableHeaderBlueGrey", -0.013888836f, -0.028334536f, -0.17254901f, 0);
    private Color color4 = decodeColor("seaglassTableHeaderBlueGrey", -0.013888836f, -0.029445238f, -0.16470587f, 0);
    private Color color5 = decodeColor("seaglassTableHeaderBlueGrey", -0.02020204f, -0.053531498f, 0.011764705f, 0);
    private Color color6 = decodeColor("seaglassTableHeaderBlueGrey", 0.055555582f, -0.10655806f, 0.24313724f, 0);
    private Color color7 = decodeColor("seaglassTableHeaderBlueGrey", 0.0f, -0.08455229f, 0.1607843f, 0);
    private Color color8 = decodeColor("seaglassTableHeaderBlueGrey", 0.0f, -0.07016757f, 0.12941176f, 0);
    private Color color9 = decodeColor("seaglassTableHeaderBlueGrey", 0.0f, -0.07466974f, 0.23921567f, 0);
    private Color color10 = decodeColor("seaglassTableHeaderFocus", 0.0f, 0.0f, 0.0f, 0);
    private Color color11 = decodeColor("seaglassTableHeaderBlueGrey", 0.055555582f, -0.10658931f, 0.25098038f, 0);
    private Color color12 = decodeColor("seaglassTableHeaderBlueGrey", 0.0f, -0.08613607f, 0.21960783f, 0);
    private Color color13 = decodeColor("seaglassTableHeaderBlueGrey", 0.0f, -0.07333623f, 0.20392156f, 0);
    private Color color14 = decodeColor("seaglassTableHeaderBlueGrey", 0.0f, -0.110526316f, 0.25490195f, 0);
    private Color color15 = decodeColor("seaglassTableHeaderBlueGrey", -0.00505054f, -0.05960039f, 0.10196078f, 0);
    private Color color16 = decodeColor("seaglassTableHeaderBlueGrey", 0.0f, -0.017742813f, 0.015686274f, 0);
    private Color color17 = decodeColor("seaglassTableHeaderBlueGrey", -0.0027777553f, -0.0018306673f, -0.02352941f, 0);
    private Color color18 = decodeColor("seaglassTableHeaderBlueGrey", 0.0055555105f, -0.020436227f, 0.12549019f, 0);
    private Color color19 = decodeColor("seaglassTableHeaderBase", -0.023096085f, -0.62376213f, 0.4352941f, 0);
    private Color color20 = decodeColor("seaglassTableHeaderBase", -0.0012707114f, -0.50901747f, 0.31764704f, 0);
    private Color color21 = decodeColor("seaglassTableHeaderBase", -0.002461195f, -0.47139505f, 0.2862745f, 0);
    private Color color22 = decodeColor("seaglassTableHeaderBase", -0.0051222444f, -0.49103343f, 0.372549f, 0);
    private Color color23 = decodeColor("seaglassTableHeaderBase", -8.738637E-4f, -0.49872798f, 0.3098039f, 0);
    private Color color24 = decodeColor("seaglassTableHeaderBase", -2.2029877E-4f, -0.4916465f, 0.37647057f, 0);
