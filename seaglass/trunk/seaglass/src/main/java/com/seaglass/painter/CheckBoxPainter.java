...
public final class CheckBoxPainter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor("seaglassButton1c", 0.0f, -0.06766917f, 0.07843137f, 0);
    private Color color2 = decodeColor("seaglassButton1c", 0.0f, -0.06484103f, 0.027450979f, 0);
    private Color color3 = decodeColor("seaglassButton2", 0.032459438f, -0.60996324f, 0.36470586f, 0);
    private Color color4 = decodeColor("seaglassButton2", 0.02551502f, -0.5996783f, 0.3215686f, 0);
    private Color color5 = decodeColor("seaglassButton2", 0.032459438f, -0.59624064f, 0.34509802f, 0);
    private Color color6 = decodeColor("seaglassButton1c", 0.0f, 0.0f, 0.0f, -89);
    private Color color7 = decodeColor("seaglassButton1c", 0.0f, -0.05356429f, -0.12549019f, 0);
    private Color color8 = decodeColor("seaglassButton1c", 0.0f, -0.015789472f, -0.37254903f, 0);
    private Color color9 = decodeColor("seaglassButton2c", 0.08801502f, -0.63174605f, 0.43921566f, 0);
    private Color color10 = decodeColor("seaglassButton2c", 0.032459438f, -0.5953556f, 0.32549018f, 0);
    private Color color11 = decodeColor("seaglassButton2c", 0.032459438f, -0.59942394f, 0.4235294f, 0);
    private Color color12 = decodeColor("nimbusFocus", 0.0f, 0.0f, 0.0f, 0);
    private Color color13 = decodeColor("seaglassButton1c", 0.0f, -0.020974077f, -0.21960783f, 0);
    private Color color14 = decodeColor("seaglassButton1c", 0.01010108f, 0.08947369f, -0.5294118f, 0);
    private Color color15 = decodeColor("seaglassButton2", 0.08801502f, -0.6317773f, 0.4470588f, 0);
    private Color color16 = decodeColor("seaglassButton2", 0.032459438f, -0.5985242f, 0.39999998f, 0);
    private Color color17 = decodeColor("seaglassButton2", 0.0f, -0.6357143f, 0.45098037f, 0);
    private Color color18 = decodeColor("seaglassButton1c", 0.055555582f, 0.8894737f, -0.7176471f, 0);
    private Color color19 = decodeColor("seaglassButton1c", 0.0f, 0.0016232133f, -0.3254902f, 0);
    private Color color20 = decodeColor("seaglassButton2", 0.027408898f, -0.5847884f, 0.2980392f, 0);
    private Color color21 = decodeColor("seaglassButton2", 0.029681683f, -0.52701867f, 0.17254901f, 0);
    private Color color22 = decodeColor("seaglassButton2", 0.029681683f, -0.5376751f, 0.25098038f, 0);
    private Color color23 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.34585923f, -0.007843137f, 0);
    private Color color24 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.10238093f, -0.25490198f, 0);
    private Color color25 = decodeColor("seaglassButton2", 0.004681647f, -0.6197143f, 0.43137252f, 0);
    private Color color26 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.44153953f, 0.2588235f, 0);
    private Color color27 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.4602757f, 0.34509802f, 0);
    private Color color28 = decodeColor("seaglassButton2", -0.57865167f, -0.6357143f, -0.54901963f, 0);
    private Color color29 = decodeColor("seaglassButton1c", 0.0f, -0.110526316f, 0.25490195f, 0);
    private Color color30 = decodeColor("seaglassButton2", -3.528595E-5f, 0.026785731f, -0.23529413f, 0);
    private Color color31 = decodeColor("seaglassButton2", -4.2033195E-4f, -0.38050595f, 0.20392156f, 0);
    private Color color32 = decodeColor("seaglassButton2", -0.0021489263f, -0.2891234f, 0.14117646f, 0);
    private Color color33 = decodeColor("seaglassButton2", -0.006362498f, -0.016311288f, -0.02352941f, 0);
    private Color color34 = decodeColor("seaglassButton2", 0.0f, -0.17930403f, 0.21568626f, 0);
    private Color color35 = decodeColor("seaglassButton2", 0.0013483167f, -0.1769987f, -0.12156865f, 0);
    private Color color36 = decodeColor("seaglassButton2", 0.05468172f, 0.3642857f, -0.43137258f, 0);
    private Color color37 = decodeColor("seaglassButton2", 0.004681647f, -0.6198413f, 0.43921566f, 0);
    private Color color38 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.4555341f, 0.3215686f, 0);
    private Color color39 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.47377098f, 0.41960782f, 0);
    private Color color40 = decodeColor("seaglassButton1c", -0.01111114f, -0.03771078f, 0.062745094f, 0);
    private Color color41 = decodeColor("seaglassButton1c", -0.02222222f, -0.032806106f, 0.011764705f, 0);
    private Color color42 = decodeColor("seaglassButton2", 0.021348298f, -0.59223604f, 0.35294116f, 0);
    private Color color43 = decodeColor("seaglassButton2", 0.021348298f, -0.56722116f, 0.3098039f, 0);
    private Color color44 = decodeColor("seaglassButton2", 0.021348298f, -0.56875f, 0.32941175f, 0);
    private Color color45 = decodeColor("seaglassButton2", 0.027408898f, -0.5735674f, 0.14509803f, 0);
