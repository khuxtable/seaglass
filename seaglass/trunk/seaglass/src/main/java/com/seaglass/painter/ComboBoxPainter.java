...
public final class ComboBoxPainter extends AbstractImagePainter {
    ...
    protected String getImageName(int state) {
        switch(state) {
            case BACKGROUND_DISABLED: return "combo_box";
            case BACKGROUND_DISABLED_PRESSED: return "combo_box";
            ...
            case BACKGROUND_PRESSED_FOCUSED: return "combo_box";
            case BACKGROUND_PRESSED: return "combo_box";
            case BACKGROUND_ENABLED_SELECTED: return "combo_box";
            case BACKGROUND_DISABLED_EDITABLE: return "combo_box_editable";
            case BACKGROUND_ENABLED_EDITABLE: return "combo_box_editable";
            case BACKGROUND_FOCUSED_EDITABLE: return "combo_box_editable";
            case BACKGROUND_MOUSEOVER_EDITABLE: return "combo_box_editable";
            case BACKGROUND_PRESSED_EDITABLE: return "combo_box_editable";
        }
        return null;
    }
}
