 ...
 * 
 * $Id: AqvavitUtils.java 69 2009-09-14 14:49:07Z kathryn@kathrynhuxtable.org $
 */
...
public class SeaGlassUtils {
    ...
    /**
     * This draws the "Flush 3D Border" which is used throughout the Aqvavit L&F
     */
    static void drawFlush3DBorder(Graphics g, int x, int y, int w, int h) {
        // g.translate(x, y);
        // g.setColor(AqvavitLookAndFeel.getControlDarkShadow());
        // g.drawRect(0, 0, w - 2, h - 2);
        // g.setColor(AqvavitLookAndFeel.getControlHighlight());
        // g.drawRect(1, 1, w - 2, h - 2);
        // g.setColor(AqvavitLookAndFeel.getControl());
    ...
    static void drawDisabledBorder(Graphics g, int x, int y, int w, int h) {
        // g.translate(x, y);
        // g.setColor(AqvavitLookAndFeel.getControlShadow());
    ...
    static void drawActiveButtonBorder(Graphics g, int x, int y, int w, int h) {
        drawFlush3DBorder(g, x, y, w, h);
        // g.setColor(AqvavitLookAndFeel.getPrimaryControl());
        // g.drawLine(x + 1, y + 1, x + 1, h - 3);
        // g.drawLine(x + 1, y + 1, w - 3, x + 1);
        // g.setColor(AqvavitLookAndFeel.getPrimaryControlDarkShadow());
    ...
    static void paintView(Graphics g, View v, Rectangle r) {
        Graphics2D g2d = (Graphics2D) g.create();
        g2d.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
        v.paint(g2d, r);
    }
    ...
    private static class GradientPainter extends CachedPainter {
        ...
        protected void paintToImage(Component c, Image image, Graphics g, int w, int h, Object[] args) {
            ...
            if (isVertical) {
                drawVerticalGradient(g2, ((Number) gradient.get(0)).floatValue(), ((Number) gradient.get(1)).floatValue(),
                    (Color) gradient.get(2), (Color) gradient.get(3), (Color) gradient.get(4), w, h);
            } else {
                drawHorizontalGradient(g2, ((Number) gradient.get(0)).floatValue(), ((Number) gradient.get(1)).floatValue(),
                    (Color) gradient.get(2), (Color) gradient.get(3), (Color) gradient.get(4), w, h);
            }
        }
