...
public final class SeaGlassStyle extends SynthStyle {
     ...
     * 
     * @param v
     *            The Values object to be initialized
     * @param myDefaults
     *            a map of UIDefaults to use in initializing the Values. This
     *            map must contain only keys associated with this Style.
     */
    @SuppressWarnings("unchecked")
    private void init(Values v, TreeMap<String, Object> myDefaults) {
        ...
        if (statesString != null) {
            ...
            stateCodes.put("Enabled", SynthConstants.ENABLED);
            stateCodes.put("MouseOver", SynthConstants.MOUSE_OVER);
            stateCodes.put("Pressed", SynthConstants.PRESSED);
            stateCodes.put("Disabled", SynthConstants.DISABLED);
            stateCodes.put("Focused", SynthConstants.FOCUSED);
            stateCodes.put("Selected", SynthConstants.SELECTED);
            stateCodes.put("Default", SynthConstants.DEFAULT);
        }
