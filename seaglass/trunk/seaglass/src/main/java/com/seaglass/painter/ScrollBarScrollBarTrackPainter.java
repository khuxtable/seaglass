...
public final class ScrollBarScrollBarTrackPainter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor("seaglassScrollBarTrackBase", -0.027777791f, -0.10016362f, 0.011764705f, 0);
    private Color color2 = decodeColor("seaglassScrollBarTrackBase", -0.027777791f, -0.100476064f, 0.035294116f, 0);
    private Color color3 = decodeColor("seaglassScrollBarTrackBase", 0.055555582f, -0.10606203f, 0.13333333f, 0);
    private Color color4 = decodeColor("seaglassScrollBarTrackBase", -0.6111111f, -0.110526316f, 0.24705881f, 0);
    private Color color5 = decodeColor("seaglassScrollBarTrackBase", 0.02222228f, -0.06465475f, -0.31764707f, 0);
    private Color color6 = decodeColor("seaglassScrollBarTrackBase", 0.0f, -0.06766917f, -0.19607842f, 0);
    private Color color7 = decodeColor("seaglassScrollBarTrackBase", -0.006944418f, -0.0655825f, -0.04705882f, 0);
    private Color color8 = decodeColor("seaglassScrollBarTrackBase", 0.0138888955f, -0.071117446f, 0.05098039f, 0);
    private Color color9 = decodeColor("seaglassScrollBarTrackBase", 0.0f, -0.07016757f, 0.12941176f, 0);
    private Color color10 = decodeColor("seaglassScrollBarTrackBase", 0.0f, -0.05967886f, -0.5137255f, 0);
    private Color color11 = decodeColor("seaglassScrollBarTrackBase", 0.0f, -0.05967886f, -0.5137255f, -255);
    private Color color12 = decodeColor("seaglassScrollBarTrackBase", -0.027777791f, -0.07826825f, -0.5019608f, -255);
    private Color color13 = decodeColor("seaglassScrollBarTrackBase", -0.015872955f, -0.06731644f, -0.109803915f, 0);
    private Color color14 = decodeColor("seaglassScrollBarTrackBase", 0.0f, -0.06924191f, 0.109803915f, 0);
    private Color color15 = decodeColor("seaglassScrollBarTrackBase", -0.015872955f, -0.06861015f, -0.09019607f, 0);
    private Color color16 = decodeColor("seaglassScrollBarTrackBase", 0.0f, -0.06766917f, 0.07843137f, 0);
