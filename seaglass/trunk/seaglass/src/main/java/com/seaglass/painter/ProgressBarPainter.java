...
public final class ProgressBarPainter extends AbstractRegionPainter {
    ...
    private Color                  color17                  = decodeColor("progressBarAmber", 0.0f, 0.0f, 0.0f, -156);
    private Color                  color18                  = decodeColor("progressBarAmber", -0.015796512f, 0.02094239f, -0.15294117f, 0);
    private Color                  color19                  = decodeColor("progressBarAmber", -0.004321605f, 0.02094239f, -0.0745098f, 0);
    private Color                  color20                  = decodeColor("progressBarAmber", -0.008021399f, 0.02094239f, -0.10196078f, 0);
    private Color                  color21                  = decodeColor("progressBarAmber", -0.011706904f, -0.1790576f, -0.02352941f, 0);
    private Color                  color22                  = decodeColor("progressBarAmber", -0.048691254f, 0.02094239f, -0.3019608f, 0);
    private Color                  color23                  = decodeColor("progressBarAmber", 0.003940329f, -0.7375322f, 0.17647058f, 0);
    private Color                  color24                  = decodeColor("progressBarAmber", 0.005506739f, -0.46764207f, 0.109803915f, 0);
    private Color                  color25                  = decodeColor("progressBarAmber", 0.0042127445f, -0.18595415f, 0.04705882f, 0);
    private Color                  color26                  = decodeColor("progressBarAmber", 0.0047626942f, 0.02094239f, 0.0039215684f, 0);
    private Color                  color27                  = decodeColor("progressBarAmber", 0.0047626942f, -0.15147138f, 0.1607843f, 0);
    private Color                  color28                  = decodeColor("progressBarAmber", 0.010665476f, -0.27317524f, 0.25098038f, 0);
    private Color                  color29                  = decodeColor("nimbusBlueGrey", -0.54444444f, -0.08748484f, 0.10588235f, 0);
    private Color                  color30                  = decodeColor("progressBarAmber", 0.0047626942f, -0.21715283f, 0.23921567f, 0);
    ...
    private Color                  color33                  = decodeColor("progressBarAmber", 0.024554357f, -0.8873145f, 0.10588235f, -156);
    private Color                  color34                  = decodeColor("progressBarAmber", -0.023593787f, -0.7963165f, 0.02352941f, 0);
    private Color                  color35                  = decodeColor("progressBarAmber", -0.010608241f, -0.7760873f, 0.043137252f, 0);
    private Color                  color36                  = decodeColor("progressBarAmber", -0.015402906f, -0.7840576f, 0.035294116f, 0);
    private Color                  color37                  = decodeColor("progressBarAmber", -0.017112307f, -0.8091547f, 0.058823526f, 0);
    private Color                  color38                  = decodeColor("progressBarAmber", -0.07044564f, -0.844649f, -0.019607842f, 0);
    private Color                  color39                  = decodeColor("progressBarAmber", -0.009704903f, -0.9381485f, 0.11372548f, 0);
    private Color                  color40                  = decodeColor("progressBarAmber", -4.4563413E-4f, -0.86742973f, 0.09411764f, 0);
    private Color                  color41                  = decodeColor("progressBarAmber", -4.4563413E-4f, -0.79896283f, 0.07843137f, 0);
    private Color                  color42                  = decodeColor("progressBarAmber", 0.0013274103f, -0.7530961f, 0.06666666f, 0);
    private Color                  color43                  = decodeColor("progressBarAmber", 0.0013274103f, -0.7644457f, 0.109803915f, 0);
    private Color                  color44                  = decodeColor("progressBarAmber", 0.009244293f, -0.78794646f, 0.13333333f, 0);
    ...
    private Color                  color50                  = decodeColor("progressBarAmber", 0.0014062226f, -0.77816474f, 0.12941176f, 0);

    // FIXME These are not assigned properly.
    private static final Insets    insets                   = new Insets(5, 5, 5, 5);
    private static final Dimension dimension                = new Dimension(29, 19);
    ...
    private static final Dimension fgDimension              = new Dimension(27, 19);
    private static final Dimension fgIndeterminateDimension = new Dimension(30, 13);

    public ProgressBarPainter(Which state) {
        super();
        this.state = state;
        Dimension dim = dimension;
        if (state == Which.FOREGROUND_ENABLED || state == Which.FOREGROUND_ENABLED_FINISHED || state == Which.FOREGROUND_DISABLED
                || state == Which.FOREGROUND_DISABLED_FINISHED) {
            dim = fgDimension;
        } else if (state == Which.FOREGROUND_ENABLED_INDETERMINATE || state == Which.FOREGROUND_DISABLED_INDETERMINATE) {
            dim = fgIndeterminateDimension;
        }
        this.ctx = new PaintContext(insets, dim, false, cacheMode, maxH, maxV);
    }
    ...
    private Path2D decodePath1() {
        ...
        path.curveTo(decodeAnchorX(0.6000000238418579f, 2.0f), decodeAnchorY(2.8933334350585938f, 0.0f), decodeAnchorX(3.0f, 0.0f),
            decodeAnchorY(2.8933334350585938f, 0.0f), decodeX(3.0f), decodeY(2.8933334f));
        ...
        path.curveTo(decodeAnchorX(3.0f, 0.0f), decodeAnchorY(0.12000000476837158f, 0.0f), decodeAnchorX(0.6000000238418579f, 2.0f),
            decodeAnchorY(0.12666666507720947f, 0.0f), decodeX(0.6f), decodeY(0.12666667f));
        path.closePath();
        return path;
    }
    ...
    private Path2D decodePath2() {
        ...
        path.curveTo(decodeAnchorX(0.54666668176651f, -2.000000000000001f), decodeAnchorY(0.12666666507720947f, 0.0f), decodeAnchorX(
            0.12000000476837158f, 0.0f), decodeAnchorY(0.6066666841506958f, -1.9999999999999998f), decodeX(0.120000005f),
            decodeY(0.6066667f));
        path.lineTo(decodeX(0.120000005f), decodeY(2.4266667f));
        path.curveTo(decodeAnchorX(0.12000000476837158f, 0.0f), decodeAnchorY(2.426666736602783f, 2.0f), decodeAnchorX(0.5800000429153442f,
            -2.0f), decodeAnchorY(2.879999876022339f, 0.0f), decodeX(0.58000004f), decodeY(2.8799999f));
        path.lineTo(decodeX(2.4f), decodeY(2.8733335f));
        path.curveTo(decodeAnchorX(2.4000000953674316f, 1.9709292441265305f), decodeAnchorY(2.87333345413208f, 0.019857039365145823f),
            decodeAnchorX(2.866666793823242f, -0.03333333333333499f), decodeAnchorY(2.433333158493042f, 1.9333333333333869f),
            decodeX(2.8666668f), decodeY(2.4333332f));
        ...
        path.curveTo(decodeAnchorX(2.866666793823242f, 0.0042173304174148996f), decodeAnchorY(0.6066666841506958f, -1.9503377583381705f),
            decodeAnchorX(2.4599997997283936f, 1.9659460194139413f), decodeAnchorY(0.13333334028720856f, 0.017122267221350018f),
            decodeX(2.4599998f), decodeY(0.13333334f));
    ...
    private Path2D decodePath3() {
        ...
        path.curveTo(decodeAnchorX(0.0f, 2.678571428571433f), decodeAnchorY(1.3333333730697632f, 8.881784197001252E-16f), decodeAnchorX(
            1.3678570985794067f, -6.214285714285715f), decodeAnchorY(0.20714285969734192f, -0.03571428571428292f), decodeX(1.3678571f),
            decodeY(0.20714286f));
        path.lineTo(decodeX(1.5642858f), decodeY(0.20714286f));
        path.curveTo(decodeAnchorX(1.5642857551574707f, 8.329670329670357f), decodeAnchorY(0.20714285969734192f, 0.002747252747249629f),
            decodeAnchorX(2.5999999046325684f, -5.2857142857142705f), decodeAnchorY(1.3333333730697632f, 0.03571428571428559f),
            decodeX(2.6f), decodeY(1.3333334f));
        ...
        path.curveTo(decodeAnchorX(2.5999999046325684f, -5.321428571428569f), decodeAnchorY(1.6666667461395264f, 0.0357142857142847f),
            decodeAnchorX(1.5642857551574707f, 8.983516483516496f), decodeAnchorY(2.799999952316284f, 0.03846153846153122f),
            decodeX(1.5642858f), decodeY(2.8f));
        path.lineTo(decodeX(1.3892857f), decodeY(2.8f));
        path.curveTo(decodeAnchorX(1.389285683631897f, -6.714285714285704f), decodeAnchorY(2.799999952316284f, 0.0f), decodeAnchorX(0.0f,
            2.6071428571428568f), decodeAnchorY(1.6666667461395264f, 0.03571428571428559f), decodeX(0.0f), decodeY(1.6666667f));
    ...
    private Path2D decodePath4() {
        ...
        path
            .curveTo(decodeAnchorX(0.59333336353302f, -1.9999999999999993f), decodeAnchorY(0.12000000476837158f, 0.0f), decodeAnchorX(
                0.12000000476837158f, 0.0f), decodeAnchorY(0.59333336353302f, -2.000000000000001f), decodeX(0.120000005f),
                decodeY(0.59333336f));
        path.curveTo(decodeAnchorX(0.12000000476837158f, 0.0f), decodeAnchorY(0.59333336353302f, 1.9999999999999991f), decodeAnchorX(
            0.12000000476837158f, 0.0f), decodeAnchorY(2.3933331966400146f, -2.0000000000000053f), decodeX(0.120000005f),
            decodeY(2.3933332f));
        path.curveTo(decodeAnchorX(0.12000000476837158f, 0.0f), decodeAnchorY(2.3933331966400146f, 2.000000000000007f), decodeAnchorX(
            0.59333336353302f, -1.9999999999999993f), decodeAnchorY(2.8866665363311768f, 0.0f), decodeX(0.59333336f), decodeY(2.8866665f));
        path.curveTo(decodeAnchorX(0.59333336353302f, 2.000000000000003f), decodeAnchorY(2.8866665363311768f, 0.0f), decodeAnchorX(
            2.700000047683716f, 0.0f), decodeAnchorY(2.879999876022339f, 0.0f), decodeX(2.7f), decodeY(2.8799999f));
        ...
        path.curveTo(decodeAnchorX(2.7599997520446777f, 0.0f), decodeAnchorY(0.13333334028720856f, 0.0f), decodeAnchorX(0.59333336353302f,
            2.000000000000003f), decodeAnchorY(0.12000000476837158f, 0.0f), decodeX(0.59333336f), decodeY(0.120000005f));
        path.closePath();
        return path;
    }
    ...
    private Path2D decodePath5() {
        ...
        path.moveTo(decodeX(0.0f), decodeY(1.3333334f));
        path.curveTo(decodeAnchorX(0.0f, 2.678571428571433f), decodeAnchorY(1.3333333730697632f, 8.881784197001252E-16f), decodeAnchorX(
            1.3678570985794067f, -6.357142857142872f), decodeAnchorY(0.20714285969734192f, -0.03571428571428337f), decodeX(1.3678571f),
            decodeY(0.20714286f));
        path.lineTo(decodeX(1.5642858f), decodeY(0.20714286f));
        path.curveTo(decodeAnchorX(1.5642857551574707f, 3.9999999999999964f), decodeAnchorY(0.20714285969734192f, 0.0f), decodeAnchorX(
            2.5999999046325684f, -5.2857142857142705f), decodeAnchorY(1.3333333730697632f, 0.03571428571428559f), decodeX(2.6f),
            decodeY(1.3333334f));
        path.lineTo(decodeX(3.0f), decodeY(1.3333334f));
        path.lineTo(decodeX(3.0f), decodeY(1.6666667f));
        path.lineTo(decodeX(2.6f), decodeY(1.6666667f));
        path.curveTo(decodeAnchorX(2.5999999046325684f, -5.321428571428569f), decodeAnchorY(1.6666667461395264f, 0.0357142857142847f),
            decodeAnchorX(1.5642857551574707f, 3.999999999999986f), decodeAnchorY(2.799999952316284f, 0.0f), decodeX(1.5642858f),
            decodeY(2.8f));
        path.lineTo(decodeX(1.3892857f), decodeY(2.8f));
        path.curveTo(decodeAnchorX(1.389285683631897f, -6.571428571428584f), decodeAnchorY(2.799999952316284f, -0.035714285714286476f),
            decodeAnchorX(0.0f, 2.6071428571428568f), decodeAnchorY(1.6666667461395264f, 0.03571428571428559f), decodeX(0.0f),
            decodeY(1.6666667f));
        path.lineTo(decodeX(0.0f), decodeY(1.3333334f));
        path.closePath();
        return path;
    ...
    private Paint decodeGradient3(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
            0.05483871f,
            0.5032258f,
            0.9516129f }, new Color[] { color9, decodeColor(color9, color10, 0.5f), color10 });
    }
