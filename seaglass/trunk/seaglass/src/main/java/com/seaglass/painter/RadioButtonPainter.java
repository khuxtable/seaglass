...
public final class RadioButtonPainter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor("seaglassButton1", 0.0f, -0.06766917f, 0.07843137f, 0);
    private Color color2 = decodeColor("seaglassButton1", 0.0f, -0.06413457f, 0.015686274f, 0);
    private Color color3 = decodeColor("seaglassButton1", 0.0f, -0.08466425f, 0.16470587f, 0);
    private Color color4 = decodeColor("seaglassButton1", 0.0f, -0.07016757f, 0.12941176f, 0);
    private Color color5 = decodeColor("seaglassButton1", 0.0f, -0.070703305f, 0.14117646f, 0);
    private Color color6 = decodeColor("seaglassButton1", 0.0f, -0.07052632f, 0.1372549f, 0);
    private Color color7 = decodeColor("seaglassButton1", 0.0f, 0.0f, 0.0f, -112);
    private Color color8 = decodeColor("seaglassButton1", 0.0f, -0.053201474f, -0.12941176f, 0);
    private Color color9 = decodeColor("seaglassButton1", 0.0f, 0.006356798f, -0.44313726f, 0);
    private Color color10 = decodeColor("seaglassButton1", 0.055555582f, -0.10654225f, 0.23921567f, 0);
    private Color color11 = decodeColor("seaglassButton1", 0.0f, -0.07206477f, 0.17254901f, 0);
    private Color color12 = decodeColor("nimbusFocus", 0.0f, 0.0f, 0.0f, 0);
    private Color color13 = decodeColor("seaglassButton1", -0.00505054f, -0.027819552f, -0.2235294f, 0);
    private Color color14 = decodeColor("seaglassButton1", 0.0f, 0.24241486f, -0.6117647f, 0);
    private Color color15 = decodeColor("seaglassButton1", -0.111111104f, -0.10655806f, 0.24313724f, 0);
    private Color color16 = decodeColor("seaglassButton1", 0.0f, -0.07333623f, 0.20392156f, 0);
    private Color color17 = decodeColor("seaglassButton1", 0.08585858f, -0.067389056f, 0.25490195f, 0);
    private Color color18 = decodeColor("seaglassButton1", -0.111111104f, -0.10628903f, 0.18039215f, 0);
    private Color color19 = decodeColor("seaglassButton1", 0.0f, -0.110526316f, 0.25490195f, 0);
    private Color color20 = decodeColor("seaglassButton1", 0.055555582f, 0.23947367f, -0.6666667f, 0);
    private Color color21 = decodeColor("seaglassButton1", -0.0777778f, -0.06815343f, -0.28235295f, 0);
    private Color color22 = decodeColor("seaglassButton1", 0.0f, -0.06866585f, 0.09803921f, 0);
    private Color color23 = decodeColor("seaglassButton1", -0.0027777553f, -0.0018306673f, -0.02352941f, 0);
    private Color color24 = decodeColor("seaglassButton1", 0.002924025f, -0.02047892f, 0.082352936f, 0);
    private Color color25 = decodeColor("seaglassButton2", 2.9569864E-4f, -0.36035198f, -0.007843137f, 0);
    private Color color26 = decodeColor("seaglassButton2", 2.9569864E-4f, 0.019458115f, -0.32156867f, 0);
    private Color color27 = decodeColor("seaglassButton2", 0.004681647f, -0.6195853f, 0.4235294f, 0);
    private Color color28 = decodeColor("seaglassButton2", 0.004681647f, -0.56704473f, 0.36470586f, 0);
    private Color color29 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.43866998f, 0.24705881f, 0);
    private Color color30 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.44879842f, 0.29019606f, 0);
    private Color color31 = decodeColor("seaglassButton1", -0.027777791f, -0.07243107f, -0.33333334f, 0);
    private Color color32 = decodeColor("seaglassButton1", -0.6111111f, -0.110526316f, -0.74509805f, 0);
    private Color color33 = decodeColor("seaglassButton1", -0.027777791f, 0.07129187f, -0.6156863f, 0);
    private Color color34 = decodeColor("seaglassButton2", -0.57865167f, -0.6357143f, -0.49803925f, 0);
    private Color color36 = decodeColor("seaglassButton2", -0.0017285943f, -0.4367347f, 0.21960783f, 0);
    private Color color37 = decodeColor("seaglassButton2", -0.0010654926f, -0.31349206f, 0.15686274f, 0);
    private Color color38 = decodeColor("seaglassButton2", 0.0f, 0.0f, 0.0f, 0);
    private Color color39 = decodeColor("seaglassButton2", 8.05676E-4f, -0.12380952f, 0.109803915f, 0);
    private Color color40 = decodeColor("seaglassButton1", -0.027777791f, -0.080223285f, -0.4862745f, 0);
    private Color color41 = decodeColor("seaglassButton2", -6.374717E-4f, -0.20452163f, -0.12156865f, 0);
    private Color color42 = decodeColor("seaglassButton2", -0.57865167f, -0.6357143f, -0.5058824f, 0);
    private Color color43 = decodeColor("seaglassButton2", -0.011985004f, -0.6157143f, 0.43137252f, 0);
    private Color color44 = decodeColor("seaglassButton2", 0.004681647f, -0.56932425f, 0.3960784f, 0);
    private Color color45 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.4555341f, 0.3215686f, 0);
    private Color color46 = decodeColor("seaglassButton2", 5.1498413E-4f, -0.46550155f, 0.372549f, 0);
    private Color color47 = decodeColor("seaglassButton2", 0.0024294257f, -0.47271872f, 0.34117645f, 0);
    private Color color48 = decodeColor("seaglassButton2", 0.010237217f, -0.56289876f, 0.2588235f, 0);
    private Color color49 = decodeColor("seaglassButton2", 0.016586483f, -0.5620301f, 0.19607842f, 0);
    private Color color50 = decodeColor("seaglassButton2", 0.027408898f, -0.5878882f, 0.35294116f, 0);
    private Color color51 = decodeColor("seaglassButton2", 0.021348298f, -0.56722116f, 0.3098039f, 0);
    private Color color52 = decodeColor("seaglassButton2", 0.021348298f, -0.567841f, 0.31764704f, 0);
    private Color color53 = decodeColor("seaglassButton1", -0.01111114f, -0.058170296f, 0.0039215684f, 0);
    private Color color54 = decodeColor("seaglassButton1", -0.013888836f, -0.04195489f, -0.058823526f, 0);
    private Color color55 = decodeColor("seaglassButton1", 0.009259284f, -0.0147816315f, -0.007843137f, 0);
