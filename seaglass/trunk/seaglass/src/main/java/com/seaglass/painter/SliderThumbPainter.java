...
public final class SliderThumbPainter extends AbstractRegionPainter {
    ...
    public static final int BACKGROUND_FOCUSED_MOUSEOVER = 4;
    public static final int BACKGROUND_FOCUSED_PRESSED = 5;
    public static final int BACKGROUND_MOUSEOVER = 6;
    public static final int BACKGROUND_PRESSED = 7;
    public static final int BACKGROUND_ENABLED_ARROWSHAPE = 8;
    public static final int BACKGROUND_DISABLED_ARROWSHAPE = 9;
    public static final int BACKGROUND_MOUSEOVER_ARROWSHAPE = 10;
    public static final int BACKGROUND_PRESSED_ARROWSHAPE = 11;
    public static final int BACKGROUND_FOCUSED_ARROWSHAPE = 12;
    public static final int BACKGROUND_FOCUSED_MOUSEOVER_ARROWSHAPE = 13;
    public static final int BACKGROUND_FOCUSED_PRESSED_ARROWSHAPE = 14;
