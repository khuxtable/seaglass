 ...
 * 
 */
public class FolderUpIcon implements Icon {
    ...
    private void paintShapeNode_0_0_0_3(Graphics2D g) {
        ...
        shape3.moveTo(7.5530734, 5.004159);
        shape3.lineTo(4.781785, 8.095689);
        shape3.lineTo(5.666239, 8.095689);
        shape3.lineTo(5.666239, 10.999854);
        shape3.lineTo(9.498871, 10.999854);
        shape3.lineTo(9.498871, 8.095689);
        shape3.lineTo(10.383324, 8.095689);
        shape3.lineTo(7.553073, 5.004159);
        shape3.closePath();
        g.setPaint(new LinearGradientPaint(new Point2D.Double(2.437295436859131, -4.580644130706787), new Point2D.Double(-0.7786262631416321, -4.580644130706787), new float[] {0.0f,1.0f}, new Color[] {new Color(33, 153, 255, 255),new Color(171, 236, 255, 255)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.8868346214294434f, 0.0f, 0.0f, 1.4989235401153564f, 6.137946605682373f, 13.435602188110352f)));
        g.fill(shape3);
